...
public class BarcodeReader extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    private void requestPermission() {
        ...
        PermissionUtil.checkPermission(getActivity(), Manifest.permission.CAMERA, new PermissionUtil.PermissionAskListener() {
            ...
            public void onPermissionPreviouslyDenied() {
                ...
                alertDialogBuilder.setTitle("Enable Camera");
                alertDialogBuilder
                        .setMessage("For the best experience, QrcodeScanner needs to use Camera Permission. Do you want to enable your Camera?")
                        .setCancelable(false)
                        .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                dialog.dismiss();
                                ActivityCompat.requestPermissions(context, new String[]{Manifest.permission.CAMERA}, 23);
            ...
            public void onPermissionDisabled() {
                ...
                alertDialogBuilder.setTitle("Camera Permission Required");
                alertDialogBuilder
                        .setMessage("For the best experience, please enable Permission->Camera in the application settings.")
                        .setCancelable(false)
    ...
    public void playBeep() {
        ...
        try {
            ...
            AssetFileDescriptor descriptor = context.getAssets().openFd(beepSoundFile != null ? beepSoundFile : "orignal.mp3");
